...
# Atualiazando dados em um dicionário
...
# 1 - Podemos utlizar uma lista para isso? Sim
...
produto1 = ('Palystation 4', 1, 2300.00)
produto2 = ('God of War 4', 1, 150.00)
...
produto2 = {'nome': 'God of Wsr 4', 'quantidade': 1, 'preço': 150.00}
...
d = dict(a=1, b=2, c=3) # Método NÃO Convencional
